...
# font family &7 font size functionality
...
def find_func(event=None):
    ...
    find_dialogue.geometry('380x150+500+200')
...
def hide_toolbar():
    ...
    if show_toolbar:
        ...
        tool_bar.pack(side=tk.TOP,fil=tk.X)
        text_editor.pack(fill=tk.BOTH,expand=True)
        status_bar.pack(side=tk.BOTTOM)
        show_toolbar=True      
...
# ----------------------------- end of main manu  functionality----------------------------
